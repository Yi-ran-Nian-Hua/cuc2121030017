...
![KernalVersion](pictures\Find the kernel version of Linux.png)
...
![](pictures\InternetCardInformation.png)

使用`ip a`命令查看当前系统内的网络情况

![](pictures\SystemInternetCardInformation.png)

现在，添加一块新网卡（NAT转换）

![](pictures\anothercard.png)
...
​		<img src="pictures\kengen2.png" style="zoom: 67%;" />
